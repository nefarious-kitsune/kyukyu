...
module.exports = {
  ...
  commands: [
    ...
    // event
    {
      ...
      responseNextWheel: 'Hero in the next Wheel of Fortune: {HERO} ({HERO2})\n',
      responseCurrentCM: 'Heroes in this Card Master: {HERO}\n',
      responseCurrentWheel: 'Hero in this Wheel of Fortune: {HERO} ({HERO2})\n',
    ...
    {name: 'event-add', hidden: true, aliases: ['event-add', 'events-add']},
    {name: 'event-of', hidden: true, aliases: ['event-of', 'events-of']},
    {
      name: 'event-list',
    ...
    // faq
    {
      ...
      items: [
        ...
        },
        {
          aliases: ['gem', 'gems'],
          desc: 'Help with gems',
          related: ['gem-purchase', 'arena-battle', 'hero-event', 'medal', 'temple-of-fusion', 'arena-reward'],
        ...
        },
        {
          ...
          related: ['arena-battle', 'gem'],
          files: [path.resolve(__dirname, 'faq', 'arena-rewards.json')],
        },
        {
        ...
        },
        {
          ...
          related: ['clan-point', 'arena-battle'],
        ...
        },
        {
          ...
          related: ['hero', 'hero-upgrade', 'hero-sale', 'gem'],
          files: [
        ...
        },
        {
          ...
          related: ['gem-purchase', 'gem', 'medal'],
